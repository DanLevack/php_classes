 ...
 * @subpackage ini_files
 * @desc Provides methods for reading and writing INI files.
 *       
...
class ini_files {
  ...
  /**
   * @method write_ini_file
   * @desc This is the write_ini_file function. It will be used to write changes to
   *       the INI files.
   * 
